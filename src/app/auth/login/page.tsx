        ...
        >
          <div className="flex-1 flex flex-col justify-center p-6 lg:p-8 items-center overflow-y-auto">
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-sm text-gray-400">Log in to your R.E.S. account</p>
            </div>
          ...
          {error && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              className="mb-4 p-3 bg-red-500/10 border border-red-500/50 rounded-lg flex items-start space-x-3"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-4 w-full max-w-md">
            ...
            {process.env.NEXT_PUBLIC_RECAPTCHA_SITE_KEY ? (
              ...
              <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-3 text-yellow-200 text-xs text-center">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="flex items-center justify-center px-3 py-2.5 bg-white/5 border border-white/10 rounded-lg text-white text-sm hover:bg-white/10 transition"
            >
